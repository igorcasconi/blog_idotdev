...
//
    ...
    public function index()
    {
        ...
        $article_sql = Articles::where('article_menu_id','=',1)->where('article_active','=',1)->get();
        $article_web = Articles::where('article_menu_id','=',2)->where('article_active','=',1)->get();
        $article_mobile = Articles::where('article_menu_id','=',4)->where('article_active','=',1)->get();
